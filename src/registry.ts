...
export function FacebookPixelScriptResolver() {
...
export const registry: (resolve?: (s: string) => string) => RegistryScripts = (resolve?: (s: string) => string) => {
  ...
  return [
    ...
    },
    {
      ...
      scriptBundling: FacebookPixelScriptResolver,
      category: 'tracking',
