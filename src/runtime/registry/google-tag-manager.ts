...
export const GoogleTagManagerOptions = object({ id: string(), l: optional(string()) })
export type GoogleTagManagerInput = RegistryScriptInput<typeof GoogleTagManagerOptions>

function use(options: GoogleTagManagerInput) {
  return { dataLayer: window[options.l!] as DataLayer, google_tag_manager: window.google_tag_manager }
}
...
export function useScriptGoogleTagManager(_options?: GoogleTagManagerInput) {
  ...
  return useRegistryScript<ReturnType<typeof use>, typeof GoogleTagManagerOptions>(_options?.key || 'googleTagManager', options => ({
    ...
    // eslint-disable-next-line
        clientInit: import.meta.server ? undefined : () => {window[options.l!]=window[options.l!]||[];window[options.l!].push({'gtm.start':new Date().getTime(),event:'gtm.js'});},
  }), _options)
}
