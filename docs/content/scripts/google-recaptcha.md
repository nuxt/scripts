...
## [`useScriptGoogleRecaptcha()`](/scripts/google-recaptcha){lang="ts"}

The [`useScriptGoogleRecaptcha()`](/scripts/google-recaptcha){lang="ts"} composable lets you have fine-grain control over when and how reCAPTCHA is loaded on your site.
