...
**Direct static maps:** `<ScriptGoogleMapsStaticMap>`{lang="html"} loads images directly from Google with the public browser key. Restrict the key to your website and the Maps Static API.
