...
description: Add advanced markers, info windows, and custom HTML popups to a Google map.
---
...
These examples build on Google's [advanced markers](https://developers.google.com/maps/documentation/javascript/advanced-markers/overview) and [info windows](https://developers.google.com/maps/documentation/javascript/infowindows). Follow those guides when you need options beyond the component props shown here.
  ...
  >
    ...
    >
      ...
      >
        <div class="bg-white p-3 px-4 rounded-lg shadow-lg max-w-[200px]">
          <p class="m-0 mb-2">
            Vue content styled by your app.
          </p>
          <button @click.stop="showPopup = false">
            Close
          </button>
