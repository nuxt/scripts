...
description: Group dense sets of Google Maps markers with the marker clusterer component.
---
...
`ScriptGoogleMapsMarkerClusterer` wraps the official [`@googlemaps/markerclusterer` library](https://googlemaps.github.io/js-markerclusterer/), grouping nearby markers into clusters at lower zoom levels.
...
Use the `#renderer` slot to render cluster visuals with a Vue template.
