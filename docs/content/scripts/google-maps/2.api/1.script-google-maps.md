...
By providing your own placeholder slot with custom content (not using the provided `placeholder` URL), the default Static Maps image is not rendered and no Static Maps API charges are incurred.
