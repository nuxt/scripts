...
description: Add a reactive advanced marker with optional custom Vue content.
---
...
This component uses Google's [`AdvancedMarkerElement`](https://developers.google.com/maps/documentation/javascript/advanced-markers/start), which requires a map ID. Nuxt Scripts falls back to Google's `DEMO_MAP_ID`, but Google reserves that ID for testing; pass your own `mapId` in production.
