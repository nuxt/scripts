...
Write the state on hover, and clear it on leave.
...
The `center`, `zoom`, `bearing`, and `pitch` props jump the camera. If you want an animation, or a fit to a bounding box, call the map.
