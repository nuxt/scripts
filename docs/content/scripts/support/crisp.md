...
<div class="not-prose">
  ...
  <div class="text-center">
    ...
    <UAlert v-else color="green" variant="soft" title="Crisp is loaded" description="The Crisp Facade component is no longer being displayed."></UAlert>
  </div>
</div>
</template>
```
