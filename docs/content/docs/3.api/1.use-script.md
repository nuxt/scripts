...
Try the live [Custom Script Example](https://stackblitz.com/github/nuxt/scripts/tree/main/examples/custom-script) on StackBlitz.
::

This composable is a wrapper around the Unhead [`useScript()`](https://unhead.unjs.io/usage/composables/use-script){lang="ts"} with extra Nuxt goodies on top, for
