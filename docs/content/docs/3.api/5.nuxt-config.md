...
- Type: `boolean | ProxyPrivacyInput`{lang="ts"}
...
- Default: `'preload'` for scripts with `onNuxtReady` or `client` triggers, `false` otherwise
...
See the [Bundling](/docs/guides/first-party) documentation for more details.
...
See the [Bundling - Subresource Integrity](/docs/guides/first-party#subresource-integrity-sri) documentation for more details.
