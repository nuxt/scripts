...
The `bundle` option is deprecated. Bundling is now auto-enabled per-script via the capabilities system. See [First-Party Mode](/docs/guides/first-party) for the recommended approach.
::
