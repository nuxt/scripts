...
Registry scripts doesn't stop you from making use of the core [`useScript()`](/docs/api/use-script){lang="ts"} features, you can provide extra options to opt-in to the advanced features.
