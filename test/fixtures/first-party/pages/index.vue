<template>
  <div>
    <h1>First-Party Script Test Fixture</h1>
    <h2>Analytics</h2>
    <ol>
      <li><NuxtLink to="/ga">Google Analytics</NuxtLink></li>
      <li><NuxtLink to="/gtm">Google Tag Manager</NuxtLink></li>
      ...
      <li><NuxtLink to="/databuddy">Databuddy Analytics</NuxtLink></li>
      <li><NuxtLink to="/matomo">Matomo Analytics</NuxtLink></li>
      <li><NuxtLink to="/mixpanel">Mixpanel Analytics</NuxtLink></li>
      <li><NuxtLink to="/segment">Segment</NuxtLink></li>
      <li><NuxtLink to="/vercel-analytics">Vercel Analytics</NuxtLink></li>
      <li><NuxtLink to="/clarity">Clarity</NuxtLink></li>
    ...
    <ol start="17">
      ...
      <li><NuxtLink to="/snap">Snapchat Pixel</NuxtLink></li>
      <li><NuxtLink to="/reddit">Reddit Pixel</NuxtLink></li>
      <li><NuxtLink to="/bing">Bing UET</NuxtLink></li>
      <li><NuxtLink to="/adsense">Google AdSense</NuxtLink></li>
    ...
    <ol start="32">
      ...
      <li><NuxtLink to="/google-maps-test">Google Maps</NuxtLink></li>
      <li><NuxtLink to="/google-sign-in-test">Google Sign-In</NuxtLink></li>
    </ol>
  </div>
</template>
