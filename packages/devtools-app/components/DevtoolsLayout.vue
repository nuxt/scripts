    ...
    <div class="relative bg-base flex flex-col min-h-screen">
      ...
      <div v-if="isStandalone" class="standalone-path-bar">
        <div class="standalone-path-inner">
          ...
          <span class="text-xs text-[var(--color-text-muted)]">Page:</span>
          <span class="standalone-path-display">{{ path }}</span>
          <span class="text-[10px] text-[var(--color-text-subtle)] italic">synced from app</span>
        </div>
      </div>
