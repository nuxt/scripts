...
<template>
  <div class="standalone-connect">
    <div class="standalone-connect-card">
      ...
      <p class="text-xs text-[var(--color-text-subtle)] text-center max-w-sm leading-relaxed">
        Requires <code class="font-mono px-1 py-0.5 rounded bg-[var(--color-surface-sunken)]">standaloneDevtools: true</code> in your <code class="font-mono px-1 py-0.5 rounded bg-[var(--color-surface-sunken)]">scripts</code> module config.
      </p>
