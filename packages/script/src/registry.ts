...
// Exported for docs site and devtools consumers.
export const CAP_FULL_PT: ScriptCapabilities = { bundle: true, proxy: true, partytown: true }
export const CAP_FULL: ScriptCapabilities = { bundle: true, proxy: true }
export const CAP_BUNDLE_PT: ScriptCapabilities = { bundle: true, partytown: true }
export const CAP_BUNDLE: ScriptCapabilities = { bundle: true }
export const CAP_PROXY: ScriptCapabilities = { proxy: true }
