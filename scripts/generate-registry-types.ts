...
const componentToSlug: Record<string, string> = {
  ...
  ScriptMapLibreScaleControl: 'maplibre',
  ScriptMapLibreGeolocateControl: 'maplibre',
  ScriptMapLibreFullscreenControl: 'maplibre',
  ScriptMapLibreAttributionControl: 'maplibre',
